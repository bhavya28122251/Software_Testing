        ...
        switch (typeof options.opts) {
            case 'undefined': {
                ...
                if (fs.existsSync(defaultMochaOptsFileName)) {
                    ...
                    this.log.debug('No mocha opts file found, not loading additional mocha options (%s was not defined).', propertyPath()('mochaOptions', 'opts'));
                    return {};
                }
            }
            case 'string': {
                ...
                switch (args[0]) {
                    ...
                    case '-u':
                        mochaRunnerOptions.ui =
                            this.parseNextString(args) ?? DEFAULT_MOCHA_OPTIONS.ui;
                        break;
                    case '--grep':
                    case '-g': {
